...
def get_vcenter_extensions():
    ...
    #   -------------  --------  -------------------------
        ...
        # At or after the following build number com.vmware.vcIntegrity no longer registers a thumbprint.
        (VcVersion.V9, 25370922, 'com.vmware.vcIntegrity'),
        ...
        # At or after the following build number com.vmware.vim.eam no longer registers a thumbprint.
        (VcVersion.V9, 25370922, 'com.vmware.vim.eam'),

        (VcVersion.V8, None,     'com.vmware.vlcm.client'),
        # At or after the following build number com.vmware.vlcm.client no longer registers a thumbprint.
        (VcVersion.V9, 25370922, 'com.vmware.vlcm.client'),
    ]
